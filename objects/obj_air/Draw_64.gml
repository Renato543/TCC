if(surface_exists(obj_game.my_surf)) {
	...
	draw_sprite_ext(sprite_index, image_index, my_x + variation + anxiety_shake_x, my_y + anxiety_shake_y, xscale * size * obj_game.breathe_scale, yscale * size * obj_game.breathe_scale, image_angle, image_blend, size/1);
